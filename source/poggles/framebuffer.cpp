...
auto poggles::addTexture2D(framebuffer_handle const& framebuffer,
                           GLenum attachment,
...
auto poggles::setDrawBuffers(framebuffer_handle const& framebuffer,
                             std::vector<GLenum> const& attachments) -> void
{
